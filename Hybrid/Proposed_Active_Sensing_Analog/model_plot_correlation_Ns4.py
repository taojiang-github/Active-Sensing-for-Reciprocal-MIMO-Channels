...
def plot_array_response_sensing(Wa_all, Wb_all, U, V, idx=1):
    for ii in range(num_iter):
        ...
        plt.xlabel('The eigenvector index',fontsize=14)
        plt.ylabel('Inner product value',fontsize=14)
...
with torch.no_grad():
    ...
    # plot_array_response_sensing(Wa_all, Wb_all, U, V,idx=4)
    plot_array_response_data(Wa_final, Wb_final, U, V,idx=4)
